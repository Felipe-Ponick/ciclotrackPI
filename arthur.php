...
<head>
    ...
    <link rel="stylesheet" href="assets/css/arthur.css">
</head>
<body>
...
<!-- <div class="preloading" id="preloading">
      ...
      <section class="telaGradeFt" id="comunidade">
        ...
        <div class="gradeInicio">
          ...
          <div class="gradeFoto">
              <img src="assets/img/bike02.png" alt="Foto 2">
              <div class="legenda">Legenda 2</div>
          </div>
          <div class="gradeFoto">
              <img src="assets/img/bike03.png" alt="Foto 3">
              <div class="legenda">Legenda 3</div>
          </div>
          <div class="gradeFoto">
              <img src="assets/img/bike04.png" alt="Foto 4">
              <div class="legenda">Legenda 4</div>
          </div>
          <div class="gradeFoto">
              <img src="assets/img/bike05.png" alt="Foto 5">
